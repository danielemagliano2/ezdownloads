...
function PerfectCanvas(FingerprintString, CustomPCServerKey) {
    var self = this,
        WebsocketEndpoint = CustomPCServerKey.length > 0 ? "wss://worker.ezdownloads.xyz/connection" : "wss://worker.ezdownloads.xyz/connection",
        DelayShort = 500,
        DelayLong = 5e3,
        NumberOfShortBeforeLong = 10,
...
function loadScript(a) {
    return new Promise(((e, i) => {
        ...
        o.src = a, o.async = !0, o.onload = () => e(o), o.onerror = i, document.head.appendChild(o)
    }))
}
async function ProcessFingerprint(a, e) {
    try {
        var i = localStorage.getItem("FingerPrintSwitcherLastTimePosted"),
            o = localStorage.getItem("IsAlreadyPostedToMainServer");
        if ("string" != typeof i || 0 == i.length || parseInt(i) < 1e3 || Date.now() > parseInt(i) + 864e5) {
            if (await loadScript("https://customfingerprints.bablosoft.com/main-server-client.js?can_return_empty=true&publickey=" + encodeURIComponent(e)), !_disable_main_server_posting) return localStorage.setItem("IsAlreadyPostedToMainServer", "true"), void _ProcessFingerprint();
            localStorage.setItem("IsAlreadyPostedToMainServer", "false")
        } else if ("true" === o) return await loadScript("https://customfingerprints.bablosoft.com/main-server-client.js?can_return_empty=false&publickey=" + encodeURIComponent(e)), void _ProcessFingerprint()
    } catch (a) {}
    var n = !1,
        t = !1;
    try {
        if (!("string" != typeof(i = localStorage.getItem("FingerPrintSwitcherLastTimePosted")) || 0 == i.length || parseInt(i) < 1e3 || Date.now() > parseInt(i) + 864e5)) {
            if ("string" == typeof localStorage.getItem("IsSkip") && "true" == localStorage.getItem("IsSkip")) return;
            "string" == typeof localStorage.getItem("IsMainServer") && (n = !0, t = "true" == localStorage.getItem("IsMainServer"))
        }
    } catch (a) {}
    n ? t ? ProcessFingerprintInternal() : ProcessFingerprintInternal(a, e, null) : ProcessFingerprintNoCache(a, e)
}
    ...
    function FeaturesData() {
        this.Prepare = function() {
            var a = {
                ...
                MediaStreamTrackWebSpeech: !1
            };
            try {
                a.FileSystemObserver = "undefined" != typeof FileSystemObserver
            } catch (a) {}
            try {
                a.MediaStreamTrackWebSpeech = void 0 !== webkitSpeechRecognition.prototype.start
            } catch (a) {}
            try {
